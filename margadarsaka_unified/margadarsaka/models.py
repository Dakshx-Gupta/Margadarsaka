...
class UserProfile(BaseModel):
    ...
    mental_skills_scores: Dict[MentalSkill, float] = Field(
        default_factory=dict, description="Mental skill assessment scores"
    )
...
class Resource(BaseModel):
    ...
    resource_type: str  # course, article, video, book, etc.
...
class Recommendation(BaseModel):
    ...
    mentorship_opportunities: List[Resource]
    job_opportunities: List[Resource]
