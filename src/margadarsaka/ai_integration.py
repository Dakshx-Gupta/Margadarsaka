...
class GeminiAI:
    ...
    def generate_career_recommendations(
        self, profile: UserProfile, test_results: Optional[List[Dict[str, Any]]] = None
    ) -> AIRecommendation:
    ...
    def chat_with_user(
        self, message: str, profile: UserProfile, chat_history: List[ChatMessage] = None
    ) -> str:
    ...
    def _prepare_context(
        self, profile: UserProfile, test_results: List[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    def _prepare_chat_context(
        self, profile: UserProfile, chat_history: List[ChatMessage]
    ) -> str:
